...
if (_city getVariable ["spawn_more",false]) then {
	...
	for "_i" from 1 to (3 + round random 3) do { [[[_pos, _radius] call btc_fnc_randomize_pos, 0, 300, 13, 0, 60 * (pi / 180), 0] call BIS_fnc_findSafePos] call btc_fnc_mil_create_motorized;};
